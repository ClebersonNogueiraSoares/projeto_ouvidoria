...
<body>
    ...
    @if(session('solicitacao')&& session('solicitacao') == 'vazio')

    <script>
swal({
    title: "Ops!",
    text: "Digite um número de protocolo!",
    icon: "warning",
});
    </script>

    @endif 
    @if(session('solicitacao')&& session('solicitacao') == 'invalido')
    <script>
        swal({
            title: "Desculpe!",
    ...
    @endif
    @if(session('solicitacao')&& session('solicitacao') == 'nenhumProtocolo')
    <script>
        swal({
            title: "Ops!",
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <div class="control-group box-btn col-md-12">
                                                <button type="submit" name="botao" class="btn btn-primary" value="1" id="protocolo-cidadao" onclick="teste()">
                                            ...
                                            <div class="control-group box-btn col-md-12">
                                                ...
                                                <button type="submit" name="cadastrar" class="btn btn-primary"  id="cadReclamacao" value="2">
                                                    <span class="glyphicon glyphicon-send"></span>
                                                    Abrir Solicitação
                                                </button>
                                            </div>
                                            <div class="control-group box-btn col-md-12">
                                                ...
                                                <button type="submit" name="meusProtocolos" class="btn btn-primary" id="meusProtocolos">
                                                    <span class="glyphicon glyphicon-send"></span>
