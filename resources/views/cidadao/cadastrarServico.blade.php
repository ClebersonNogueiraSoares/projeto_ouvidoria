                        ...
                        <div class="box-content">
                            ...
                            <section  class="container box-form">
                                <div class="col-md-8 col-md-offset-2 well">
                                    <form class="form-horizontal"  name="form" id="form" method="post" action="{{action('CidadaoController@moveDeCadastro')}}" enctype="multipart/form-data" onsubmit="teste(event)">
                                        {{csrf_field()}}
                                        <div class="row">
                                            <div class="col-md-9">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group controls controls-row">
                                                    ...
                                                    <input type="text" name="numero"value="" class="form-control" id="numero"  placeholder="Digite o seu numero"  title="numero" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="control-group controls controls-row">
                                                    ...
                                                    <input type="text" name="bairro" class="form-control" value="" id="sublocality_level_1" placeholder="Digite o seu bairro" required>
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group controls controls-row">
                                                    ...
                                                    <input type="text" name="cep" class="form-control" value=""id="postal_code" placeholder="Digite o CEP"  title="Somente números">
